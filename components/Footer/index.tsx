      ...
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            ...
            >
              <a href="/" className="relative">
                <Image
                  width={120}
                  height={80}
                  src="/images/logo/aydex.png"
                  alt="AYDEX Technologies"
                  className="dark:hidden"
                />
                <Image
                  width={120}
                  height={80}
                  src="/images/logo/aydex-dark.png"
                  alt="AYDEX Technologies"
                  className="hidden dark:block"
                />
              </a>
              ...
              <p className="mb-10 mt-5">
                AYDEX Technologies helps businesses grow with automation,
            ...
            <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between lg:w-2/3 xl:w-7/12">
              ...
              >
                ...
                <ul>
                  ...
                  <li><a href="#support" className="mb-3 inline-block hover:text-primary">Contact</a></li>
                  <li><a href="#pricing" className="mb-3 inline-block hover:text-primary">Pricing</a></li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <ul>
                  <li className="mb-3">Automation Solutions</li>
                  <li className="mb-3">Web Development</li>
                  <li className="mb-3">Digital Marketing</li>
                  <li className="mb-3">Custom Software</li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <p className="mb-4 w-[90%]">
                  Get updates on automation, tech & growth insights.
                </p>
                ...
                <form>
                  <div className="relative">
                    <input
                      type="email"
                      placeholder="Email address"
                      className="w-full rounded-full border border-stroke px-6 py-3 shadow-solid-11 focus:border-primary focus:outline-hidden dark:border-strokedark dark:bg-black"
                    />
                    <button
        ...
        <div className="flex flex-col items-center justify-between gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row">
          ...
          <p className="text-center">
            © {new Date().getFullYear()} AYDEX Technologies. All rights reserved.
          </p>
