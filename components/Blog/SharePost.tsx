...
const SharePost = () => {
  return (
    <div className="mt-11 flex flex-wrap gap-4 md:items-center md:justify-between">
      ...
      <ul className="flex items-center gap-3 text-sm">
        <li className="text-black dark:text-white font-medium">Tags:</li>
        <li>
          <a href="#" className="hover:text-primary">#automation</a>
        </li>
        <li>
          <a href="#" className="hover:text-primary">#software</a>
        </li>
        <li>
          <a href="#" className="hover:text-primary">#digitalmarketing</a>
        </li>
      </ul>
    </div>
  );
