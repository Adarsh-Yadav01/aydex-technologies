      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Connect AYDEX With The Tools You Already Use`,
              description: `AYDEX Technologies seamlessly integrates with popular platforms for marketing, automation, cloud services, payments, and analytics — helping businesses work smarter, faster, and more efficiently.`,
            }}
          />
        </div>
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-50 mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          ...
          <div className="flex flex-wrap justify-around gap-y-10">
            ...
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_top w-1/6 text-center"
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <p className="text-sm font-semibold">Cloud & Hosting</p>
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <p className="text-sm font-semibold">Social Platforms</p>
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <p className="text-sm font-semibold">WhatsApp API</p>
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <p className="text-sm font-semibold">Analytics & Tracking</p>
              </div>
            </motion.div>
